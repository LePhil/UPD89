...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { arch: @update.arch, candidate: @update.candidate, installed: @update.installed, name: @update.name, section: @update.section, system: @update.system }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { arch: @update.arch, candidate: @update.candidate, installed: @update.installed, name: @update.name, section: @update.section, system: @update.system }
    assert_redirected_to update_path(assigns(:update))
  end
